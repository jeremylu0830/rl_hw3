...
兩者都能在實驗後期達到接近滿分（≈500）的峰值表現，不過在長時間訓練下，C51 的平均回報大約落在 400–450，而 DQN 多數集中在 260–380，整體來看 C51 約高出三、四成。

2. **C51 顯著更穩定、風險較低**
   
從陰影（標準差）可以看到，DQN 的方差明顯較大，有一些 run 會掉到約 150 的低分；C51 的陰影帶則較窄，多數 run 即使狀況不好也還在 300 左右。
→ 意味著 C51 不只「平均高」，還提供更好的 最壞情況表現，翻車機率比較小。
